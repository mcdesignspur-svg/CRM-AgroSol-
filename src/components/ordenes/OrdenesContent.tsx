...
function OrdenesPageInner({
  ...
  useEffect(() => {
    if (window.location.hash === "#nueva-orden") {
      document
        .getElementById("nueva-orden")
      ...
      <div className="flex-1 overflow-y-auto p-4 md:p-8 space-y-8 pb-10">
        <div>
          ...
          <p className="text-lg text-on-surface-variant mt-2">
            Registra nuevas órdenes y consulta el listado en un solo lugar.
          </p>
        </div>

        <section id="nueva-orden" className="scroll-mt-24">
          <div className="mb-4 flex items-center gap-2 border-b-2 border-black pb-3">
            <span className="material-symbols-outlined text-primary font-bold">
              add_shopping_cart
            </span>
            <h3 className="font-bold uppercase text-lg">Nueva Orden</h3>
          </div>
        ...
        <section className="space-y-6">
          <div className="flex items-center gap-2 border-b-2 border-black pb-3">
            ...
            <h3 className="font-bold uppercase text-lg">Órdenes Registradas</h3>
          </div>
